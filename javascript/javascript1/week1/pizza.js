...
4. Modify the log statement for the pizza man so it includes whether or not the pizza is family size, and now show the total price of the order `New pizza order: <amount of pizzas> <family or not?> <name of pizza>. Total cost for the order is: <total price>`
